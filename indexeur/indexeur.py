...
class Indexeur:
    ...
    index : dict[int,dict[tuple[str*],int]
        L'index des documents, la clé est l'id du document, en valeur un dictionnaire
        contenant les termes du document en clé et leur fréquence en valeur.
        
    indexInv : dict[tuple[str*],dict[int,int]]
        Index inverse, la clé est le terme, la valeur un dictionnaire contenant
    ...
    def __init__(self,corpusTraite):
        ...
        déjà appeler la méthode extraction.
        
        Parameters
        ----------
        corpusTraite : Corpus
             Corpus sur lequel on a déjà appeler la méthode extraction et que 
             l'on veut indexer.
        """
    ...
    def getIDFOkapiTerme(self,terme):
        ...
        fomrmule de l'idf log((0.5+N-n)/(0.5+n)), où N est le nombre de document
    ...
    def charger(self,path):
        ...
        -------
        Indexation
            L'objet Indexation charger depuis le fichier à l'emplacement path.
        """
